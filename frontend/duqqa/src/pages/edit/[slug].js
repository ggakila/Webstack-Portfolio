...
export default function Edit() {
  ...
  <div className="text-white h-screen flex flex-col items-center justify-start gap-10 p-10 py-28">
    <Link href="/" className="w-[40px] h-[40px] absolute top-10 left-10">
      <Image src="/images/back.svg" fill={true} alt="back button home" />
    </Link>
    <h1 className="text-5xl md:text-7xl font-light text-center">
      As the artist grows,<br /> so does the art
    </h1>
    <form
