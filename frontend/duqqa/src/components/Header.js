...
export default function Header() {
  return (
		<div
			className={`text-neutral-400 w-full  py-8 flex justify-between items-center px-3 font-bold ${poppins.className} `}
		>
			<h1 className={`font-bold text-7xl  ${tangerine.className}`}>Duqqa</h1>
			<div className="flex  gap-2 text-2xl text-right">
				<p className="font-semibold text-xl text-neutral-400 text-right">
