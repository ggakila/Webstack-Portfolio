...
export default function Hero() {
	return (
		<div className="w-full h-[100vh] md:h-screen flex flex-col justify-center items-center font-light bg-black">
			<p className="leading-normal tracking-normal font-thin text-[3vh]  sm:text-[3vh] md:text-[4vh]   z-10 p-10 mix-blend-difference text-white text-center w-full md:w-4/5">
			...
			<div className="  flex flex-col items-center justify-start  text-center  gap-5">
				<Link
					href="/showcase"
					className="z-10 bg-white text-black mix-blend-difference rounded-full hover:bg-orange-600 hover:text-white text-[14px]"
				>
					<p className="min-w-[200px] p-6 rounded font-bold  ">
						Share your work
					</p>
				</Link>
			</div>
